        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="index.html" class="logo">
                <span class="logo-light">
                    <span class="logo-lg"><img src="{{ asset('admin/assets/images/logo-light.png') }}"
                            alt="logo"></span>
                ...
                <div class="dropdown">
                    <a class="topbar-link dropdown-toggle drop-arrow-none px-2" data-bs-toggle="dropdown"
                        ...
                        <span class="d-lg-flex flex-column gap-1 d-none">
                            <h6 class="my-0">{{ auth()->user()->first_name . ' ' . auth()->user()->last_name }}</h6>
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <div class="dropdown-header bg-primary mt-n3 rounded-top-2">
                            <h6 class="text-overflow text-white m-0">Welcome !
