            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body pt-2">
                        <div class="row">
                            <div class="col-xl-9">
                                <form action="{{ route('update.property', $edit->id) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    <div class="form-group">
                                        <label for="amount">Amount</label>
                                        <input type="number" class="form-control" name="amount"
                                            value="{{ $edit->amount }}" id="amount" placeholder="Enter Amount">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="address"
                                            value="{{ $edit->location_text }}" id="address" placeholder="Enter Address">
                                    </div>
                                    <div class="form-group">
                                        <label for="address_link">Address Link</label>
                                        <input type="text" class="form-control" name="address_link"
                                            value="{{ $edit->location_link }}" id="address_link"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="view_detail_link"
                                            value="{{ $edit->url }}" id="view_detail_link"
                                            placeholder="Enter View Detail Link">
                                    </div>
                                    <div class="form-group">
                                        <label for="heading">Heading</label>
                                        <input type="text" class="form-control" name="heading"
                                            value="{{ $edit->heading }}" id="heading" placeholder="Enter Heading">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="description" rows="3" name="description" placeholder="Enter Description">{{ $edit->description }}</textarea>
                                    </div>
