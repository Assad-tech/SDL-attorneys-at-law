...
@section('title', 'Admin | Add New Staff')
@section('custom_css')
    ...
    <div class="page-container">
        ...
        <div class="card mt-4">
            ...
            <div class="card-body pt-2">
                <form action="{{ route('admin.supporting.staff.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <!-- Designation -->
                        <div class="col-sm-6">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="staff_education" rows="3"
                                    placeholder="Enter Education">{{ old('staff_education') }}</textarea>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="staff_professional_aff"
                                    ...
                                    value="{{ old('staff_professional_aff') }}">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="staff_bio" rows="4"
                                    placeholder="Enter Biography">{{ old('staff_bio') }}</textarea>
                                @error('staff_bio')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="staff_fb_link" placeholder="Enter Facebook Link">
                                @error('staff_fb_link')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="url" class="form-control" name="staff_insta_link" placeholder="Enter Instagram Link">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="file" class="dropify" name="staff_image">
                                @error('staff_image')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
