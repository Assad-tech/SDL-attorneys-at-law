            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="introduction-advisors">
                        ...
                        <p>Notary Public</p>
                        <h3>Biography</h3>
                        <p>Michelle Trayer is a seasoned paralegal with over 35 years of experience specializing in Family
                            ...
                            documents, organizing complex case information, managing files, and preparing cases for trial.
                            She is also a Notary Public for the State of California and is highly valued for her meticulous
                            attention to detail. Michelle takes great pride in her work and has found her professional home
                ...
                <div class="col-md-8">
                    <div class="introduction-advisors">
                        ...
                        <p>Quynh Nguyen is a highly skilled paralegal with over 15 years of experience specializing in
                            ...
                            immigration attorneys on various cases, and she also assists with family law and personal injury
                            matters. Her dedication to client service ensures that all clients, regardless of their legal
                        ...
                        <p>In addition to her legal expertise, Quynh enjoys a fulfilling personal life. She has a
                            12-year-old child and enjoys activities like hiking, going to the gym, and spending quality time
                            with her family. Quynh is also passionate about cooking and watching sports with her loved ones,
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="advisors-box">
                        ...
                        <div class="img-box">
                            <img class="img-fluid" src="{{asset('user/assets/images/advisors/ANGELIQUE RAINES.jpg')}}" alt="01 advisors">
                            <div class="img-box-hover">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-instagram"></i></a></li>
                ...
                <div class="col-md-8">
                    <div class="introduction-advisors">
                        ...
                        <h3>Biography</h3>
                        <p>Angelique Raines earned a bachelor’s degree in business administration from Point Loma Nazarene
                            University and is currently completing her paralegal certificate at the University of San Diego.
                            With 18 years of experience in the financial sector, she spent 13 years at Wells Fargo,
                            advancing from teller to manager, where she developed expertise in customer service, leadership,
                            and quality control. She then transitioned to Silvergate Bank, working for 5 years with fintech
                        ...
                        <p>Angelique will officially become paralegal in January, leveraging her extensive background in
                            business and finance to support the firm’s clients and team. Her expertise in managing complex
                            operations and fostering strong client relationships allows her to bring a fresh, valuable
                            perspective to the legal field. In her free time, Angelique enjoys curling up with a good book,
                            crocheting unique handmade creations, and spending quality time at home with her family and
                            dogs. A passionate Disney enthusiast, she delights in visiting the parks to immerse herself in
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="advisors-box">
                        ...
                        <div class="img-box">
                            <img class="img-fluid" src="{{asset('user/assets/images/advisors/KARLA MENDOZA.jpg')}}" alt="01 advisors">
                            <div class="img-box-hover">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-instagram"></i></a></li>
                ...
                <div class="col-md-8">
                    <div class="introduction-advisors">
                        ...
                        <p>NALA</p>
                        <h3>Biography</h3>
                        <p>Karla Mendoza has been a paralegal at Skaja, Daniels & Luu, LLP for three years. She is fluent in
                            Spanish; therefore, she can effectively assist and communicate with Spanish speaking clients.
                            Karla has assisted attorneys in estate planning, probate, and civil litigation matters.</p>
                        <p>Outside of work, Karla likes to spend time with her family and friends. She enjoys learning new
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="advisors-box">
                        ...
                        <div class="img-box">
                            <img class="img-fluid" src="{{asset('user/assets/images/advisors/ana.png')}}" alt="01 advisors">
                            <div class="img-box-hover">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-instagram"></i></a></li>
                ...
                <div class="col-md-8">
                    <div class="introduction-advisors">
                        ...
                        <h3>Biography</h3>
                        <p>Ana Calderon is a dedicated legal assistant at Skaja, Daniels & Luu, LLP, where she supports the
                            ...
                            Latino/Hispanic community, fostering strong relationships to make legal services accessible and
                            welcoming. Her bilingual skills and cultural insight enable her to bridge language and cultural
                            barriers, ensuring exceptional client care.</p>
                        <p>In addition to her legal support role, Ana manages the firm's social media presence, keeping the
                            community informed about events and updates. Passionate about community engagement, she actively
                            volunteers to make a positive local impact. Outside of work, Ana enjoys camping, traveling,
                            exploring local events and restaurants, and spending quality time with family and friends.</p>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="advisors-box">
                        ...
                        <div class="img-box">
                            <img class="img-fluid" src="{{asset('user/assets/images/advisors/janet-reyes.jpg')}}" alt="01 advisors">
                            <div class="img-box-hover">
                                <ul>
                                    <li><a href="#"><i class="fab fa-facebook-f"></i></a></li>
                                    <li><a href="#"><i class="fab fa-instagram"></i></a></li>
                ...
                <div class="col-md-8">
                    <div class="introduction-advisors">
                        ...
                        <p>Janet, who has many years of customer service experience, understands how to make essential
                            decisions while empathizing with each client she meets. Her ability to multitask in a variety of
                            professional settings has made her the 'go-to' person for getting the job done and ensuring the
